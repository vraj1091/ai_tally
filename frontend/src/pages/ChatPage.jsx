...
export default function ChatPage() {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      // All modes use the unified chat endpoint
      let endpoint = '/api/chat/chat'
      let body = {
        query: input,
        company_name: selectedCompany || 'Demo Company',
        collection_name: 'tally_combined'
      }

      if (selectedMode === 'tally') {
        body.collection_name = 'tally_live'
      } else if (selectedMode === 'document') {
        body.collection_name = 'documents'
      }
      ...
      const content = data.answer || data.response || data.result || 'No response received'
